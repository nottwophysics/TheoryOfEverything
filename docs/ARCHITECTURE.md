...
│   └── unity_of_experience.py       # Factorization-dependence of the branch count (paper §2.4)
│
...
│
├── tests/                           # TEST SUITE: 502 automated tests
...
```bash
pytest tests/ -v              # Run all 502 tests
...
| `pytest tests/ -v` | Run the full test suite (502 tests) |
