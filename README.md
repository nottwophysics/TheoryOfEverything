...
# Run the test suite (424 tests): install the test extra, then run from the
...
| **Test Suite** | `tests/` | 424 automated tests validating all modules |
...
- **Tested**: Full test suite (424 tests) covering every module — run with `pytest`
