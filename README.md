...
# Run the test suite (502 tests): install the test extra, then run from the
...
| **Test Suite** | `tests/` | 502 automated tests validating all modules |
...
- **Tested**: Full test suite (502 tests) covering every module — run with `pytest`
